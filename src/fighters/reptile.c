...
void playerState_Reptile(int numPlayer, u16 State)
{
    switch (State)
    {
    case PARADO:
        ...
        player[numPlayer].sprite = SPR_addSpriteExSafe(&spr_reptile, player[numPlayer].x - player[numPlayer].axisX,
    ...
    {
        PAL_setPalette(PAL2, spr_reptile.palette->data, DMA);
    } else {
